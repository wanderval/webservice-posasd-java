 ...
 * 
 */
@WebServiceClient(name = "CalculatorWS", targetNamespace = "http://test.me.org/", wsdlLocation = "http://localhost:8080/CalculatorWSApplication2/CalculatorWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORWS_QNAME = new QName("http://test.me.org/", "CalculatorWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/CalculatorWSApplication2/CalculatorWS?wsdl");
    ...
    public CalculatorWS getCalculatorWSPort() {
        return super.getPort(new QName("http://test.me.org/", "CalculatorWSPort"), CalculatorWS.class);
    }
    ...
    public CalculatorWS getCalculatorWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://test.me.org/", "CalculatorWSPort"), CalculatorWS.class, features);
    }
